...
export default function MobilidadePage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-zinc-100">Mobilidade/Fortalecimento</h1>
        <p className="text-sm text-zinc-500 mt-1">Suas opções de mobilidade e fortalecimento</p>
      </div>
